...
def test_op_yaml_int_minimum_exclusive():
    HERE = os.path.dirname(__file__)
    ...
    try:
        ...
        pytest.fail("Unexpected argument error on the integer minimum test. ")
...
def test_args_int_minimum_exclusive():
    ...
    #too low number passed.
    with pytest.raises(ArgumentError):
        api.check_args(args="=70", op=api.ops["getAllStatisticsbyUserID"])
        #api.check_path(path="/users/30/statistics?q=70", op=api.ops["getAllStatisticsbyUserID"])
...
def test_op_yaml_int_maximum_exclusive():
    HERE = os.path.dirname(__file__)
    ...
    try:
        ...
        pytest.fail("Unexpected argument error on the integer maximum test. ")


#Test if checks on the maximum of numbers(floats) work
def test_op_yaml_number_minimum_exclusive():
    HERE = os.path.dirname(__file__)
    ...
    try:
        ...
        pytest.fail("Unexpected argument error on the number minimum test.")



#Test if checks on the maximum of number (floats) work
def test_op_yaml_num_maximum_exclusive():
    HERE = os.path.dirname(__file__)
...
def test_op_yaml_max_min_int_multiple():
    HERE = os.path.dirname(__file__)
    ...
    try:
        ...
        pytest.fail("Unexpected argument error on max-min multiple for integer ")
...
def test_op_yaml_max_min_num_multiple():
    HERE = os.path.dirname(__file__)
    ...
    try:
        ...
        pytest.fail("Unexpected argument error on max-min multiple for number")
...
def test_op_yaml_num_maximum_exclusive():
    ...
    try:
        ...
        pytest.fail("Unexpected argument error on the number maximum test. ")


#Test if checks on the minimum length and maximum length of a string work
def test_op_yaml_min_max_string_length():
    HERE = os.path.dirname(__file__)
    ...
    try:
        ...
        pytest.fail("Unexpected argument error on the min max string length test. ")

#Test if a date with valid format is indeed accepted
def test_op_yaml_valid_date_format():
    HERE = os.path.dirname(__file__)
    ...
    try:
        ...
        pytest.fail("Unexpected argument error in the valid date test. ")


#Test if a date-time timestamp is accepted
def test_op_yaml_valid_date_time_format():
    HERE = os.path.dirname(__file__)
